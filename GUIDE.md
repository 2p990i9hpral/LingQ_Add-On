...
- [Part I: Settings Popup Reference](#part-i-settings-popup-reference)
  - [1. Reader & Display Settings](#1-reader--display-settings)
    ...
    - [1.4 Typography & Appearance](#14-typography--appearance)
    - [1.5 Color Themes & Palette](#15-color-themes--palette)
    - [1.6 Video Captions & Player Tweaks](#16-video-captions--player-tweaks)
    - [1.7 Reader Automation Toggles](#17-reader-automation-toggles)
  - [2. Keyboard Shortcuts](#2-keyboard-shortcuts)
    - [2.1 Configuration & Hotkeys Table](#21-configuration--hotkeys-table)
  - [3. AI Chat & Models](#3-ai-chat--models)
    - [3.1 Chat Widget Dimensions & Behavior](#31-chat-widget-dimensions--behavior)
    - [3.2 Providers & Model Selection](#32-providers--model-selection)
    - [3.3 Google Vertex (GCP) Credentials](#33-google-vertex-gcp-credentials)
    - [3.4 Token Usage Log & Cost Tracking](#34-token-usage-log--cost-tracking)
    - [3.5 Quick Lesson Summary Options](#35-quick-lesson-summary-options)
...
- [Part II: Standalone Tools & Reader Features (Wiki)](#part-ii-standalone-tools--reader-features-wiki)
  - [6. Flashcard Manager & Analytics](#6-flashcard-manager--analytics)
  - [7. Local Video Player Interface](#7-local-video-player-interface)
  - [8. TTS Playground](#8-tts-playground)
  - [9. Vocabulary Downloader](#9-vocabulary-downloader)
  - [10. Memo (Notepad) Widget](#10-memo-notepad-widget)
  - [11. Print a Lesson](#11-print-a-lesson)
  - [12. In-Reader Interactive Controls](#12-in-reader-interactive-controls)
- [Part III: Setup & Integrations](#part-iii-setup--integrations)
  - [13. Supabase Cloud Database Setup](#13-supabase-cloud-database-setup)
  - [14. Anki Integration Guide](#14-anki-integration-guide)

---

# Part I: Settings Popup Reference
...
### 1.6 Video Captions & Player Tweaks
...
### 3.2 Providers & Model Selection
Enter your API key corresponding to your selected Chat Provider: (`gemini-3.1-flash-lite` is recommend for its low cost and nice response quality and speed.)
...
### 3.3 Google Vertex (GCP) Credentials
...
### 3.4 Token Usage Log & Cost Tracking
...
### 3.5 Quick Lesson Summary Options
...
- **Custom (Personal Supabase DB)**:
  ...
  - *(See [Section 13](#13-supabase-cloud-database-setup) for the complete SQL schema and setup walkthrough)*.
...
# Part II: Standalone Tools & Reader Features
...
## 7. Local Video Player Interface
...
<img src="images/download_popup.png" width=400></br>
...
## 10. Memo (Notepad) Widget

### Overview & Purpose
A persistent scratchpad docked beside the reader.
- Enable via **Show Memo Widget** in **Settings**.
- Notes are continuously preserved in local storage across browser refreshes and lesson transitions.
...
## 12. In-Reader Interactive Controls
...
## 13. Supabase Cloud Database Setup
